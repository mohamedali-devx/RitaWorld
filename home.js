    ...
    allCards.forEach(card => {
        ...
        card.addEventListener("click", () => {
            ...
            if (product.place === "ras") {
                ras.childNodes[1].innerHTML = `<div style="text-align: center; margin-bottom: -15px;">head</div><div class="image" style="width: 100px; height: 100px;"><img src="${product.image}" width="100"></div>`;
            }
            if (product.place === "chest") {
                chest.childNodes[1].innerHTML = `<div style="text-align: center; margin-bottom: -15px;">chest</div><div class="image" style="width: 100px; height: 100px;"><img src="${product.image}" width="100"></div>`;
            }
            if (product.place === "legs") {
                legs.childNodes[1].innerHTML = `<div style="text-align: center; margin-bottom: -15px;">legs</div><div class="image" style="width: 100px; height: 100px;"><img src="${product.image}" width="100"></div>`;
            }
            if (product.place === "feet") {
                feet.childNodes[1].innerHTML = `<div style="text-align: center; margin-bottom: -15px;">feet</div><div class="image" style="width: 100px; height: 100px;"><img src="${product.image}" width="100"></div>`;
            }
